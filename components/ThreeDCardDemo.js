...
export function ThreeDCardDemo({title,desc,imageUrl}) {
return (
    <CardContainer className="inter-var">
        <CardBody
            className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-[300px] sm:w-[20rem] h-auto rounded-xl p-6 border shadow-lg shadow-[#493737]  ">
            <CardItem
                translateZ="50"
